    ...
    <div class="flex flex-row w-full" :data="init">
        ...
        <nav class="w-2/12 fixed min-h-screen bg-gray-800 text-gray-400 flex flex-col cursor-pointer">
            ...
            <div class="my-1 text-center font-thin ">
                <div class="text-base w-14 m-auto h-14 bg-gray-900 hover:border-gray-200 border-transparent border rounded-full flex flex-col text-gray-300 font-black animate-pulse cursor-pointer" @click="$router.push('/')">
                    <div class="m-auto">whoobe</div>
                </div>
